...
import com.example.antalfarkas.hirplacc.network.auth.HttpBasicAuth;
import com.example.antalfarkas.hirplacc.network.auth.ApiKeyAuth;
import com.example.antalfarkas.hirplacc.network.auth.OAuth;
import com.example.antalfarkas.hirplacc.network.auth.OAuth.AccessTokenListener;
import com.example.antalfarkas.hirplacc.network.auth.OAuthFlow;
...
public class ApiClient {
   ...
   public void createDefaultAdapter() {
        ...
        String baseUrl = "https://wt-a339e6290d2b75021e179abd37d83555-0.sandbox.auth0-extend.com/";
        if(!baseUrl.endsWith("/"))
        	baseUrl = baseUrl + "/";
